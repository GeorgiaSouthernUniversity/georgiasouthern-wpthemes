...
<div id="page" class="hfeed">
	<header id="branding" role="banner">
		...
		<a href="<?php echo get_bloginfo('url');?>"><img src="<?php echo get_bloginfo('url');?>/wordpress/wp-content/themes/stem/images/img_logo.jpg" alt="STEM" id="logo" /></a>
		<img src="<?php echo get_bloginfo('url');?>/wordpress/wp-content/themes/stem/images/banner_corner.png" alt="STEM" id="banner_corner" />
